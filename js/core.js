import { DijkstraEdge, DijkstraNode, ipAddress, Component, Network, Packet } from "./network.js";
...
export class CoreState {
    ...
    addRouter(ipString) {
        ...
        let router = new Component("router", new ipAddress(ipString));
